...
Execução local:
    python 02_medallion_pipeline/DP01_Producao_Consumo/flyte_workflow.py

Execução Flyte (remoto):
    pyflyte run --remote -p flytesnacks -d development \\
      02_medallion_pipeline/DP01_Producao_Consumo/flyte_workflow.py medallion_full_wf

Backfill de intervalo específico:
    pyflyte run --remote -p flytesnacks -d development \\
      02_medallion_pipeline/DP01_Producao_Consumo/flyte_workflow.py medallion_backfill_wf \\
...
RUNNER    = REPO_ROOT / "02_medallion_pipeline" / "DP01_Producao_Consumo" / "run_medallion_pipeline.py"
