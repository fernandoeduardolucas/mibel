...
print(f"🚀 ShopNow Producer started. Sending events to {TOPIC}...")
...
try:
    while True:
        ...
        event_id = f"EVT_{random.getrandbits(32)}" # Unique ID
        ...
        # Chance of sending a duplicate (10% chance)
        ...
        # Wait a bit before the next user action
